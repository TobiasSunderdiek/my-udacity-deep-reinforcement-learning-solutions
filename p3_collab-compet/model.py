...
# Udacity Honor Code: I did not initialize layer 1 and layer 2 within my first implementation, after having a look at the solution from
...
class Critic(nn.Module):
    ...
    def forward(self, input, action):
        x = torch.cat((input, action), dim=1)#todo honor code: change +action to here
